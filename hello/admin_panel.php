...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["addFolder"])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        echo "<script>alert(' Games has been added successfully.')</script>";
    } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["addVideo"])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        echo "<script>alert(' Live Video added successfully.')</script>";
    } else {
        echo "<script>alert('Error adding Live video.')</script>";
    }
