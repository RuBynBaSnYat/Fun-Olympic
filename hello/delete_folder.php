...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        echo "<script>alert('Live sports deleted successfully.'); window.location.href = 'admin_panel.php';</script>";
        ...
        echo "<script>alert('Error deleting Live video: " . mysqli_error($conn) . "');</script>";
    }
    // Close statement
